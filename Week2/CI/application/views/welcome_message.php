...
<div id="login">
    ...
    <form method="POST" action="index.php/login">
        <label>User Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="email" value="" required></label><br /><br />
        <label>Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="password" value="" required></label>
        <br /><br />
        <input type="image" name="submit" src="images/loginbutton.jpg" border="0" alt="Submit" style="margin-left: 85px;" />
    </form>
